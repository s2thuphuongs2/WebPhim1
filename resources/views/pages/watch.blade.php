                           ...
                           <div class="halim-server">
                            <!-- tập phim - vòng lặp -->
                              <ul class="halim-list-eps">
                                 ...
                                 <a href="{{route('episode')}}"><li class="halim-episode"><span class="halim-btn halim-btn-2 halim-info-1-2 box-shadow" data-post-id="37976" data-server="1" data-episode="2" data-position="last" data-embed="0" data-title="Xem phim Tôi Và Chúng Ta Ở Bên Nhau - Tập 2 - Be Together - vietsub + Thuyết Minh" data-h1="Tôi Và Chúng Ta Ở Bên Nhau - tập 2">2</span></li>
                                    </a>
                                </ul>
                              <div class="clearfix"></div>
                           </div>
