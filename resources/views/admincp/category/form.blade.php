                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'category.store', 'method' => 'POST']) !!}
                        ...
                        <div class = "form-group">
                            ...
                            {!! Form::textarea('description', isset($category) ? $category->description : '', ['style'=>'resize:none','class' => 'form-control', 'placeholder' => 'Nhập dữ liệu...', 'id'=>'title_danhmuc']) !!}
                        </div>
                        <div class = "form-group">
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        {!! Form::open(['route' => ['category.destroy', $cate->id], 'method' => 'DELETE', 'onsubmit'=>'return confirm("Bạn chắc chắn muốn xóa?")']) !!}
